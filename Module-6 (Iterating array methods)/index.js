...
const getUsersWithGender = (users, gender) => {
    const filterUsersWithGender = users.filter(user => user.gender === gender);
    const mapUsersWithGender = filterUsersWithGender.map(user => user.name);
    return mapUsersWithGender;
};
...
const getUsersWithFriend = (users, friendName) => {
    return users.reduce((acc, { friends, name }) => {
